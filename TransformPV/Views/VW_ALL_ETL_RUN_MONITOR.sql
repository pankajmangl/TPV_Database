PROMPT View VW_ALL_ETL_RUN_MONITOR;
--
...
--   ETL_MASTER (Table)
--
CREATE OR REPLACE VIEW &TRANSFORMPV_USER..VW_ALL_ETL_RUN_MONITOR (EXECUTION_ID,
                                                     EXECUTION_SEQ,
                                                     ETL_NAME,
                                                     ETL_TYPE,
                                                     ETL_AREA,
...
AS
   SELECT   E.EXECUTION_ID, E.EXECUTION_SEQ, EM.ETL_NAME, E.ETL_TYPE,
      ...
      WHERE E.PROC_ID = ECP.CFG_PROC_ID(+) AND E.ETL_ID = EM.ETL_ID
